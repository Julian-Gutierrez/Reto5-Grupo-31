...
public class Requerimiento_2Dao {
    ...
    public ArrayList<Requerimiento_2> requerimiento2()  throws SQLException {
        ...
        try{
            ...
            String consulta = "select Nombre , Primer_Apellido, Ciudad_Residencia , Cargo , Salario, 'Ingreso por empleado' from Lider l where (Cargo = 'Asesor' OR Cargo='Coordinador') AND Salario <=310000 ;";
            ...
            System.err.println("Ërro consultando: "+e);
        }finally{
            if(conexion != null){
                conexion.close();
            }
